...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0D246D] text-white font-sans relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <button
              ...
              className="block text-sm leading-relaxed hover:text-yellow-400 transition text-left"
            >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg overflow-hidden w-[90%] max-w-2xl">
            ...
            <div className="flex justify-between items-center p-4 border-b">
              <h2 className="text-lg font-semibold text-gray-800">Lokasi di Google Maps</h2>
              <button onClick={() => setShowMap(false)} className="text-gray-600 hover:text-red-500 text-xl">&times;</button>
            </div>
